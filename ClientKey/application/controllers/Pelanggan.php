...
class Pelanggan extends CI_Controller {
    //buat variabel
    var $api ="";   
    //nilai variabel "$kunci" di dapat dari "ServerKey/config/rest.php" (baris ke 379) 
    var $kunci = "API-KEY";
    //nilai variabel "$nilai" di dapat dari "tb_kunci" pada database (pada tb_kunci ini nilainya ada 3, yaitu : PWBS,TI17,TeknologiInformasi) 
    var $nilai = "PWBS";
	...
	function __construct() 
    {
        ...
        $this->api="http://localhost/dll/@materi/PWBS-TI17AB/ServerKey/index.php";      
    ...
    function index()
    {        
        //ambil nilai dari variabel $kunci dan $nilai
        $data = array(
                $this->kunci=>$this->nilai);
        //pengambilan data dari "tb_pelanggan" dengan format JSON
        $data['pelanggan'] = json_decode($this->curl->simple_get($this->api.'/pelanggan',$data));
    ...
    {        
        ...
        else
        {
            ...
            // lihat di baris 98
            $delete =  $this->curl->simple_delete($this->api.'/pelanggan',$data, array(CURLOPT_BUFFERSIZE => 10)); 
